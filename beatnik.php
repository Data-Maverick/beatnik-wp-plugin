	...
	public function beatnik_promo_box_html($post) {
		...
		for ($x = 0; $x < self::$beatnik_tile_count; $x++) {
			...
			<div class="beatnik_tile" id="beatnik_tile_<?= $x ?>_sponsor" data-tile_id="<?= $x ?>" data-tile_target="sponsor">
				...
				<div class="beatnik_sponsor_img_container"><?php
				if ($sponsor["is_set"]) { ?>
					<img src="<?= $sponsor["img_src"][0] ?>" />
				<?php }
				?></div>
			</div>
			<div class="beatnik_tile" id="beatnik_tile_<?= $x ?>" data-tile_id="<?= $x ?>_background"  data-tile_target="background">
				...
				<div class="beatnik_background_img_container"><?php
			...
			<div class="beatnik_tile" id="beatnik_tile_<?= $x ?>" data-tile_id="<?= $x ?>_blurb"  data-tile_target="blurb">
				...
				<div class="beatnik_blurb_img_container"><?php
				if ($blurb["is_set"]) { ?>
