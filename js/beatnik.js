jQuery(function($){
  ...
  var beatnik_media_frame,
      metaBox = $('#beatnik_sponsor_box.postbox'), // Your meta box id here
      addImgLink = metaBox.find('.upload-beatnik_sponsor_logo-img'),
      delImgLink = metaBox.find( '.delete-beatnik_sponsor_logo-img'),
      imgContainer = metaBox.find( '.beatnik_sponsor_logo-container'),
      imgIdInput = metaBox.find( '.beatnik_sponsor_logo-img-id' );
